...
<Piecemaker>
  <Contents>
  	<Image Source="'.$_GET['path'].'/img/slider/flickr/taxi1.jpg" Title="Editing made Easy"></Image>
	<Image Source="'.$_GET['path'].'/img/slider/flickr/taxi2.jpg" Title="Editing made Easy"></Image>
	<Image Source="'.$_GET['path'].'/img/slider/flickr/taxi1.jpg" Title="Editing made Easy"></Image>
	<Image Source="'.$_GET['path'].'/img/slider/flickr/taxi2.jpg" Title="Editing made Easy"></Image>
  </Contents>

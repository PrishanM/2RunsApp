	...
	<div class="row-fluid">
        ...
        <div class="span3">
            ...
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/office-worker.png" width="260" height="180" alt="Me" />
            <h3>
            Ashana Jackol - <small>xxxxxxxx</small>
            </h3>
		...
		<div class="span3">
          ...
          <div class="span3">
            ...
            <div class="colored_banner thumb-content-dark">
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/office-worker.png" width="260" height="180" />
            <h3>
            Ashana Jackol - <small>yyyyyy</small>
            </h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
          ...
          <div class="span3">
            ...
            <div class="colored_banner thumb-content-dark">
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/business.png" width="260" height="180" />
            <h3>
            Shantha Paul - <small>uuuuuu</small>
            </h3>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>
  ...
  <hr />
    ...
    <div class="row-fluid">
            ...
            <div class="square-background clearfix">
                   ...
                   <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/smashing/60px/ic_24.png" alt="" class="">
          		</div>
                 <h4>24x7 Quick Service</h4>
            	...
            	<div class="square-background square-colored clearfix">
                    <div class="square square-back  pull-left">
                     ...
                     <h4>Minimum respond time</h4>
                     <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. </p>
                </div>
                
            	<div class="square-background clearfix">
                    <div class="square square-back pull-left">
                        <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/smashing/60px/safe_travelling.png" alt="" class="">
          			</div>
            ...
            <div class="square-background square-colored clearfix">
                    <div class="square square-back  pull-left">
                        <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/smashing/60px/customer_preferences.png" alt="" class="">
          </div>
                     <h4>High customer preference</h4>
                     <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. </p>
                </div>
                
            <div class="square-background clearfix">
                    <div class="square square-back pull-left">
                        <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/icons/smashing/60px/low_cost.png" alt="" class="">
          </div>
                     <h4>Minimum cost</h4>
                     <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante. </p>
                </div>
